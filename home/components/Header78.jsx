      ...
      <div className="container flex flex-col items-center">
        <div className="rb-12 mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
            Building Bavaria, one home at a time
          </h1>
          <p className="md:text-md">
            From Munich to Augsburg, we handle everything. Planning, permits,
            construction, handover—no surprises, no shortcuts. Your Bavarian
            home built right.
          </p>
          <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
            <Button title="Konsultieren">Konsultieren</Button>
            <Button title="Projekte" variant="secondary">
              Projekte
            </Button>
          </div>
        </div>
