        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "They delivered exactly what they promised, on time and within
              budget. No surprises, no excuses."
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "We felt heard from the first conversation. They understood what
              we wanted and made it happen without the usual complications."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              "A regional partner who actually knows the building codes, the
              weather, the soil. That matters more than you'd think."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
