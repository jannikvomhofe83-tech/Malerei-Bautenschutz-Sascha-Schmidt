      ...
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Trust built on completed projects and delivered promises
          </p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              They managed every detail without cutting corners, and the house
              was finished exactly when promised.
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              We were skeptical about renovation costs, but their fixed-price
              guarantee gave us peace of mind from day one.
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md font-bold leading-[1.4] md:text-xl">
              Local knowledge, professional execution, and a team that actually
